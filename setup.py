...
def fetch_version() -> str:
    version_path = os.path.join(os.path.dirname(__file__), "mup", "__version__.py")
...
if __name__ == '__main__':
    setup_dict = {
        ...
        'author_email': 'cmdev.00+mup@gmail.com',
        'url': 'https://github.com/cmontesano/mup',
        'description': 'Miscellaneous utility package.',
        'long_description': long_description(),
        'long_description_content_type': 'text/markdown',
        'packages': build_package_list('mup'),
